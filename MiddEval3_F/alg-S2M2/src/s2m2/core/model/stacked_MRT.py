...
class MRT(nn.Module):
    ...
    def __init__(self,
        ...
        self.down_conv0 = nn.Sequential(nn.AvgPool2d(2, ceil_mode=True),
                                      nn.Conv2d(dims[0], dims[1], kernel_size=1))
        self.down_conv1 = nn.Sequential(nn.AvgPool2d(2, ceil_mode=True),
                                      nn.Conv2d(dims[1], dims[2], kernel_size=1))
        self.down_conv2 = nn.Sequential(nn.AvgPool2d(2, ceil_mode=True),
